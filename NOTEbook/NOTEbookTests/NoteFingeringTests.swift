...
class NoteFingeringTests: XCTestCase {
    ...
    func testShorten() {
        ...
        XCTAssertTrue(noteFingering0.shorten(to: 7).isEmpty)
        XCTAssertTrue(noteFingering0.shorten(to: 6).isEmpty)
        XCTAssertTrue(noteFingering0.shorten(to: 5).isEmpty)
        XCTAssertTrue(noteFingering0.shorten(to: 4).isEmpty)
        XCTAssertTrue(noteFingering0.shorten(to: 3).isEmpty)
        XCTAssertTrue(noteFingering0.shorten(to: 2).isEmpty)
        XCTAssertTrue(noteFingering0.shorten(to: 1).isEmpty)
