...
//
//    @State private var instrumentType: Instrument.InstrumentType?
...
//    }
//
//    init(categoryName: String, instrumentType: Instrument.InstrumentType, minNote: Note? = nil, centerNote: Note? = nil, maxNote: Note? = nil) {
//        self.categoryName = categoryName
//        self.mode = .update
//        self._instrumentType = .init(initialValue: instrumentType)
//
//        if let minNote, let maxNote {
...
//
//                            ForEach(Instrument.InstrumentType.allCases) { type in
//                                Text(type.rawValue)
...
//                    } else if let minNote, let centerNote, let maxNote {
