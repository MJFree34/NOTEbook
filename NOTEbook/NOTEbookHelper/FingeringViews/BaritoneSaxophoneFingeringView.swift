            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                HStack(alignment: .bottom, spacing: 71) {
                    HStack(spacing: -2) {
                        ...
                        Image("SaxophoneBaritoneOctaveKey\(fingering.keys![23] ? "Full" : "Empty")")
                            .renderingMode(.template)
                    }
...
struct BaritoneSaxophoneFingeringView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            VStack {
                BaritoneSaxophoneFingeringView(fingering: Fingering(keys: [false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false]))

                BaritoneSaxophoneFingeringView(fingering: Fingering(keys: [true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true]))
            }
        }
        .padding()
