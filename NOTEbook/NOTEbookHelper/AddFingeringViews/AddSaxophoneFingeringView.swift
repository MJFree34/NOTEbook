//
//  AddSaxophoneFingeringView.swift
//  NOTEbookHelper
//
...
struct AddSaxophoneFingeringView: View {
    ...
    init(isAdd: Bool, fingering: Binding<Fingering>, key1: Bool, key2: Bool, key3: Bool, key4: Bool, key5: Bool, key6: Bool, bottom1: Bool, bottom2: Bool, chromaticFSharp: Bool, side1: Bool, side2: Bool, side3: Bool, highFSharp: Bool, fork: Bool, top1: Bool, top2: Bool, top3: Bool, low1: Bool, low2: Bool, low3: Bool, low4: Bool, bis: Bool, octave: Bool) {
        self.isAdd = isAdd
...
struct AddSaxophoneFingeringView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            AddSaxophoneFingeringView(isAdd: true, fingering: .constant(Fingering()), key1: false, key2: false, key3: false, key4: false, key5: false, key6: false, bottom1: false, bottom2: false, chromaticFSharp: false, side1: false, side2: false, side3: false, highFSharp: false, fork: false, top1: false, top2: false, top3: false, low1: false, low2: false, low3: false, low4: false, bis: false, octave: false)

            AddSaxophoneFingeringView(isAdd: false, fingering: .constant(Fingering()), key1: true, key2: true, key3: true, key4: true, key5: true, key6: true, bottom1: true, bottom2: true, chromaticFSharp: true, side1: true, side2: true, side3: true, highFSharp: true, fork: true, top1: true, top2: true, top3: true, low1: true, low2: true, low3: true, low4: true, bis: true, octave: true)
        }
