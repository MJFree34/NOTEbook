...
extension UIImage {
    ...
    struct Instruments {
        ...
        struct Clarinet {
            static let bottomKeysEmptyEmpty = "ClarinetBottomKeysEmptyEmpty"
            static let bottomKeysEmptyFull = "ClarinetBottomKeysEmptyFull"
            static let bottomKeysFullFull = "ClarinetBottomKeysFullFull"
            ...
            static let thumbKeysEmptyEmpty = "ClarinetThumbKeysEmptyEmpty"
            static let thumbKeysEmptyFull = "ClarinetThumbKeysEmptyFull"
            static let thumbKeysFullFull = "ClarinetThumbKeysFullFull"
            ...
            static let triggerKey1Empty = "ClarinetTriggerKey1Empty"
            static let triggerKey1Full = "ClarinetTriggerKey1Full"
            static let triggerKey2Empty = "ClarinetTriggerKey2Empty"
            static let triggerKey2Full = "ClarinetTriggerKey2Full"
            static let triggerKey3Empty = "ClarinetTriggerKey3Empty"
            static let triggerKey3Full = "ClarinetTriggerKey3Full"
        }
        ...
        struct Flute {
            ...
            static let leverKeysEmptyEmpty = "FluteLeverKeysEmptyEmpty"
            static let leverKeysEmptyFull = "FluteLeverKeysEmptyFull"
            static let leverKeysFullFull = "FluteLeverKeysFullFull"
            ...
            static let thumbKeysEmptyEmpty = "FluteThumbKeysEmptyEmpty"
            static let thumbKeysEmptyFull = "FluteThumbKeysEmptyFull"
            static let thumbKeysFullFull = "FluteThumbKeysFullFull"
        ...
        struct Saxophone {
            ...
            static let bottomKey1Empty = "SaxophoneBottomKey1Empty"
            static let bottomKey1Full = "SaxophoneBottomKey1Full"
            static let bottomKey2Empty = "SaxophoneBottomKey2Empty"
            static let bottomKey2Full = "SaxophoneBottomKey2Full"
            ...
            static let middleLowKeysEmptyEmpty = "SaxophoneMiddleLowKeysEmptyEmpty"
            static let middleLowKeysEmptyFull = "SaxophoneMiddleLowKeysEmptyFull"
            static let middleLowKeysFullFull = "SaxophoneMiddleLowKeysFullFull"
            ...
            static let baritoneOctaveKeyEmpty = "SaxophoneBaritoneOctaveKeyEmpty"
            static let baritoneOctaveKeyFull = "SaxophoneBaritoneOctaveKeyFull"
        }
    }
