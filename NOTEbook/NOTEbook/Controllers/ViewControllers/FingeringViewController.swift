...
class FingeringViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let finger1 = UIImageView(image: UIImage(named: (fingering.keys[0] ? "TrumpetFingeringFull" : "TrumpetFingeringEmpty")))
        finger1.translatesAutoresizingMaskIntoConstraints = false
        view.addSubview(finger1)
        
        let finger2 = UIImageView(image: UIImage(named: (fingering.keys[1] ? "TrumpetFingeringFull" : "TrumpetFingeringEmpty")))
        finger2.translatesAutoresizingMaskIntoConstraints = false
        view.addSubview(finger2)
        
        let finger3 = UIImageView(image: UIImage(named: (fingering.keys[2] ? "TrumpetFingeringFull" : "TrumpetFingeringEmpty")))
